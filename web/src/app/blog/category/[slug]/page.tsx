...
async function getPostsByCategory(categoryId: string, page: number = 1, limit: number = 10) {
...
export default async function CategoryPage({ params, searchParams }: PageProps) {
  ...
  const { posts, total, totalPages } = await getPostsByCategory(category.id, page);
    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <p className="text-purple-400 text-sm uppercase tracking-wider mb-2">Category</p>
