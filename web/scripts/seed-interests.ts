...
interface InterestData {
  ...
  slug: string;
  iconEmoji?: string;
  children?: Omit<InterestData, 'children'>[];
}

const interestCategories: Record<string, InterestData[]> = {
  'Photography': [
...
async function main() {
  ...
  console.log(`Seeded ${count} interests across ${Object.keys(interestCategories).length} categories.`);
}
